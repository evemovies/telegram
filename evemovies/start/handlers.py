...
async def _handle_start_any_text(update: Update, context: CallbackContext.DEFAULT_TYPE):
    print('starting conversation after restart')
    return stages.STAGE_MAIN


async def _handle_start_with_command(update: Update, context: CallbackContext.DEFAULT_TYPE):
